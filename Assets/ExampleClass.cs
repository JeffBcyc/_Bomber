...
// Add it to an object in your scene, and at Play time it will draw in the Scene View a small yellow line between the
// scene origin, and a position interpolated between two other positions (one on the up axis, one on the forward axis).
using UnityEngine;
